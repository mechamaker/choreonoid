...
QT_INIT_METAOBJECT const QMetaObject cnoid::ScrollBar::staticMetaObject = { {
    &QScrollBar::staticMetaObject,
    qt_meta_stringdata_cnoid__ScrollBar.data,
    qt_meta_data_cnoid__ScrollBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DoubleScrollBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onValueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
...
QT_INIT_METAOBJECT const QMetaObject cnoid::DoubleScrollBar::staticMetaObject = { {
    &QScrollBar::staticMetaObject,
    qt_meta_stringdata_cnoid__DoubleScrollBar.data,
    qt_meta_data_cnoid__DoubleScrollBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
